...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'detect_huffman = turtlebot3_autorace_detect.detect_huffman:main',
            'detect_rokey_lane = turtlebot3_autorace_detect.detect_rokey_lane:main',            
            'detect_track = turtlebot3_autorace_detect.detect_track:main',            
            'lane_detect_gui = turtlebot3_autorace_detect.lane_detect_gui:main',     
            'drive_camera = turtlebot3_autorace_detect.drive_camera:main',                     
            ...
            'image_processing = turtlebot3_autorace_detect.image_processing:main',
        ],
    },
)
