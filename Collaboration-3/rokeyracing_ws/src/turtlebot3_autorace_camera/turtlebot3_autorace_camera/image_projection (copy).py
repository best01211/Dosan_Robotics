...
class ImageProjection(Node):
    ...
    def cbImageProjection(self, msg_img):
        ...
        cv_image_original = cv2.convertScaleAbs(cv_image_original, alpha=1.0, beta=-10) # modyfied
        ...
        if self.resolution=='320x240':  
            ...
            pts_dst = np.array([[0, 0], [800, 0], [700, 600], [100, 600]])
        elif self.resolution=='640x480':
        ...
        if self.resolution=='320x240':  
            ...
            triangle1 = np.array([[0, 599], [0, 450], [100, 599]], np.int32)
            triangle2 = np.array([[999, 599], [999,450], [899, 599]], np.int32)
