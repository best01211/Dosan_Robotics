...
class ControlLane(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info('control_lane: Receive lane center data to generate lane following control commands.')
        print('control_lane: Receive lane center data to generate lane following control commands.')
